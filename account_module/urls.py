...
urlpatterns = [
    ...
    path('forget-pass-approve', views.ForgetPasswordApprove, name='forget_password_approve_page'),
    path('register-approve', views.RegisterApprove, name='register_approve_page'),
    ...
    path('my-account', views.Account_page, name='my_account'),
]
